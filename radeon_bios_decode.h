...
///**/unsigned char                       *TV_VideoMode;
    ATOM_DISP_OUT_INFO                 *TV_VideoMode;
    union {
        void                            *base;
...
typedef struct _atomCommandTables {
    //SelectCRTC_Source
    union {
        void                              *base;
        SELECT_CRTC_SOURCE_PARAMETERS     *crtcSourceParameters;
        SELECT_CRTC_SOURCE_PARAMETERS_V2  *crtcSourceParameters_v2;
    } SelectCRTC_Source;
    
    union {
        void                              *base;
        DIG_ENCODER_CONTROL_PARAMETERS    *digEncoderControlParameters;
        DIG_ENCODER_CONTROL_PARAMETERS_V3   *digEncoderControlParameters_v3;
    } DIG1EncoderControl;
...
} atomCommandTables, *atomCommandTablesPtr;
#else
